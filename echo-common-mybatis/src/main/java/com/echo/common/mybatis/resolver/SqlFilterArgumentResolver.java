...
package com.echo.common.mybatis.resolver;
...
public class SqlFilterArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    private static final String[] KEYWORDS = {"master", "truncate", "insert", "select", "delete", "update", "declare", "alter", "drop", "sleep", "extractvalue", "concat"};
