...
import com.echo.common.core.annotation.DataScope;
import com.echo.common.core.constant.UserConstants;
import com.echo.common.security.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements SysDeptService {
    ...
    public int updateDept(SysDept dept) {
        ...
        if (UserConstants.DEPT_NORMAL.equals(dept.getStatus()) && CharSequenceUtil.isNotEmpty(dept.getAncestors())
                && !CharSequenceUtil.equals("0", dept.getAncestors())) {
