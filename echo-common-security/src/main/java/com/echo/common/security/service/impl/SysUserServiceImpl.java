...
import com.echo.common.web.utils.BeanValidators;
...
import com.echo.common.security.entity.SysUserRole;
import com.echo.common.security.mapper.SysRoleMapper;
import com.echo.common.security.mapper.SysUserMapper;
import com.echo.common.security.mapper.SysUserRoleMapper;
    ...
    public void checkUserDataScope(Long userId) {
        if (!SysUser.isAdmin(SecurityUtils.getUserId())) {
            ...
            if (CollUtil.isEmpty(users)) {
                throw new ApiException("没有权限访问用户数据！");
            }
        }
    }
