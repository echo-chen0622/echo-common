...
import com.echo.common.security.mapper.SysMenuMapper;
import com.echo.common.security.mapper.SysRoleMapper;
import com.echo.common.security.mapper.SysRoleMenuMapper;
import com.echo.common.security.entity.TreeSelect;
...
import com.echo.common.security.entity.vo.MetaVo;
import com.echo.common.security.entity.vo.RouterVo;
...
public class SysMenuServiceImpl implements SysMenuService {
    ...
    public Set<String> selectMenuPermsByUserId(Long userId) {
        ...
        for (String perm : perms) {
            if (CharSequenceUtil.isNotEmpty(perm)) {
    ...
    public String getComponent(SysMenu menu) {
        ...
        if (CharSequenceUtil.isNotEmpty(menu.getComponent()) && !isMenuFrame(menu)) {
            component = menu.getComponent();
        } else if (CharSequenceUtil.isEmpty(menu.getComponent()) && menu.getParentId().intValue() != 0 && isInnerLink(menu)) {
            component = UserConstants.INNER_LINK;
        } else if (CharSequenceUtil.isEmpty(menu.getComponent()) && isParentView(menu)) {
