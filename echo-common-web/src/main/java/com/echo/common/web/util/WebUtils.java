package com.echo.common.web.util;

import cn.hutool.core.codec.Base64;
import cn.hutool.json.JSONUtil;
import com.echo.common.core.constant.CommonConstants;
...
public class WebUtils extends org.springframework.web.util.WebUtils {
    ...
    private static String[] splitClient(String header) {
        if (header == null || !header.startsWith(BASIC_)) {
            throw new ApiException("请求头中client信息为空");
        }
        ...
        try {
            ...
            throw new ApiException("Failed to decode basic authentication token");
        }
        ...
        if (delim == -1) {
            throw new ApiException("Invalid basic authentication token");
        }
